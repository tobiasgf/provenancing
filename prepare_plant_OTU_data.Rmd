...
demultiplex the data using the tag-info files availablbe here: https://github.com/tobiasgf/lulu using a slightly improved script "DADA2_demultiplex.sh" from:  
https://github.com/tobiasgf/man_vs_machine/blob/master/seq_processing/DADA2_demultiplex.sh

analyse using DADA2 implemented in custom script "dada2_sickle.r" from  
https://github.com/tobiasgf/man_vs_machine/blob/master/seq_processing/dada2_sickle.r  
...
Extract the ITS2 regions with custom script: itsx_plants_parallel.sh  
...
bash spilt_and_blast.sh  all.otus.fasta  
...
options(ENTREZ_KEY = "ENTER_YOUR_KEY_HERE")
